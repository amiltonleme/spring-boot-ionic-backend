...
public class Endereco implements Serializable {
	...
	//Vários endereços podem ser de um cidade (A cidade pode ter vários endereços)
	@ManyToOne
	//O cidade_id é o nome dado a chave estrangeira na tabela endereço que faz relacionammento com a tabela cidade
